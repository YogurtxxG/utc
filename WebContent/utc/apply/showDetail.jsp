...
<body>
	<div id="panel" class="easyui-panel" title="报销申请单"
		...
		<form id="addForm" method="post" action="<%=request.getContextPath()%>/utc/reimbursement/AddToReimbursement.action">
			...
			<td></td>
			<td>时间:</td>
			<td><input id="date" type="text" name="date"  class="easyui-datebox" value="<%=DateUtils.getSystemDate()%>"></input></td>
			<td></td>
			<td>员工名:</td>
			...
			<tr>
				<td>备注:</td>
				<td><textarea id="remark" name="remark" style="width:260px; height:50px"></textarea></td>
			</tr>
			</table>
			<div style="padding: 10px;" >
				<a href="#" class="easyui-linkbutton" onclick="add();" iconCls="icon-search">确定</a>
